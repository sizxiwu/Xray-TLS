...
## 📸 安装过程可视化 (Installation Walkthrough)

#### 1. 启动脚本，显示主菜单 (Main Menu)
<div align="center">
<img src="https://i.imgur.com/e7TzX1J.png" width="600" alt="主菜单"/>
</div>

> 输入 `1` 并回车开始安装。

#### 2. 输入基本信息 (Domain & Email)
```
┌───────────────────────────────────────────────────┐
│ 请输入 TLS 使用的域名（例如 xxx.com）： your.domain.com      │
│ 请输入用于证书注册的邮箱： admin@your.domain.com         │
└───────────────────────────────────────────────────┘
```

#### 3. 域名解析自动检测 (DNS Check)
<div align="center">
<img src="https://i.imgur.com/j4oG3QY.png" width="600" alt="DNS 检测"/>
</div>

> 脚本会自动获取服务器 IP，并持续查询域名解析记录，直到匹配成功。

#### 4. 选择协议与传输方式 (Protocol & Transport)
```
┌───────────────────────────────────────────────────┐
│ 请选择代理协议:                                       │
│ 1) VMess                                          │
...
│ 请选择传输协议:                                       │
│ 1) WebSocket + TLS (ws)                           │
│ 2) TCP + TLS (HTTP Camouflage)                    │
│ 请输入选项 [1-2]: 2                                   │
└───────────────────────────────────────────────────┘
```
#### 5. ✨ 自定义 HTTP 伪装 (Customize HTTP Camouflage)
<div align="center">
<img src="https://i.imgur.com/qL6iXgI.png" width="600" alt="自定义伪装"/>
</div>

> 这是脚本的核心亮点之一。您可以直接回车使用默认值，也可以输入您想伪装成的任意网站头部信息。

#### 6. 安装完成！(Installation Complete)
<div align="center">
<img src="https://i.imgur.com/vH8wP2O.png" width="600" alt="安装完成"/>
</div>

> 脚本会清晰地列出您的所有配置信息，并生成可以直接导入客户端的分享链接。
